...
delta = 1/(t^2)
  ...
  for(t in (length(pair_exp)+1):t){
    ...
    for(l in 1:length(actions)){
      ut_i[l] = 1/n_i[l] * sum(losses[1:t,l], 
                               na.rm =  T)
...
for(l in 1:1000){ 
  losses[l, 1] = rbinom(1,1, 0.1)
  losses[l, 2] = rbinom(1,1,0.4)
}
for(p in 101:10000){
  losses[p,1] = rbinom(1,1,1)
  losses[p,2] = rbinom(1,1,0)
}
return(losses)
}
